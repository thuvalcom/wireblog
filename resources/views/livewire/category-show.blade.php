<div>
    @section('title')
        ...
        @endpush
    @endsection
    <h3 class="mb-2 mt-6 text-center text-3xl font-bold">List of category {{ $category->name }}</h3>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:col-span-2">
                    ...
                    @foreach ($posts as $post)
                        <div class="mb-8 overflow-hidden rounded-lg bg-white shadow-md">
                            ...
                            <div class="p-4 lg:p-6">
                                <h2
                                    class="mb-2 text-xl font-bold text-gray-900 hover:text-indigo-800 lg:text-2xl xl:text-3xl">
                ...
                @else
                    <div class="rounded-lg bg-white">
                        ...
                        <p class="mb-4 text-lg text-gray-700">No articles for this category.</p>
                            ...
                            @foreach ($categories as $category)
                                <li class="flex items-center">
                                    ...
                                    <a wire:navigate href="{{ route('category', $category->slug) }}"
                                        class="text-slate-900 hover:bg-indigo-600 hover:px-4 hover:py-1 hover:text-white">{{ $category->name }}</a>
                                </li>
                            @endforeach
